...
$hashed_metag = {
                  ...
                  'g1_rules' => [
                                  ...
                                  {
                                    'action' => '[start,length,values]',
                                    'bless' => 'event_declaration',
                                    'lhs' => 'event declaration',
                                    'mask' => [
                                                1,
                                                1,
                                                1,
                                  ...
                                  {
                                    'action' => '[start,length,values]',
                                    'bless' => 'forgiving_specification',
                                    'lhs' => 'forgiving specification',
                                    'mask' => [
                                                0,
                                                0,
                                                1
