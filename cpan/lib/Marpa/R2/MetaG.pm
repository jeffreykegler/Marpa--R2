...
$hashed_metag = {
                  'character_classes' => {
                                           ...
                                           '[[\\s]]' => qr/(?^msx:[\s])/,
                                           '[[\\w]]' => qr/(?^msx:[\w])/,
                                           '[[\\x{A}\\x{B}\\x{C}\\x{D}\\x{2028}\\x{2029}]]' => qr/(?^umsx:[\x{A}\x{B}\x{C}\x{D}\x{2028}\x{2029}])/,
                                           '[[\\|]]' => qr/(?^msx:[\|])/,
                                           '[[\\~]]' => qr/(?^msx:[\~])/,
                                           '[[^\'\\x{0A}\\x{0B}\\x{0C}\\x{0D}\\x{0085}\\x{2028}\\x{2029}]]' => qr/(?^umsx:[^'\x{0A}\x{0B}\x{0C}\x{0D}\x{0085}\x{2028}\x{2029}])/,
                                           '[[^\\x{5d}\\x{0A}\\x{0B}\\x{0C}\\x{0D}\\x{0085}\\x{2028}\\x{2029}]]' => qr/(?^umsx:[^\x{5d}\x{0A}\x{0B}\x{0C}\x{0D}\x{0085}\x{2028}\x{2029}])/,
                                           '[[^\\x{A}\\x{B}\\x{C}\\x{D}\\x{2028}\\x{2029}]]' => qr/(?^umsx:[^\x{A}\x{B}\x{C}\x{D}\x{2028}\x{2029}])/,
                                           '[[a-zA-Z]]' => qr/(?^msx:[a-zA-Z])/,
                                           '[[a]]' => qr/(?^msx:[a])/,
                                           '[[b]]' => qr/(?^msx:[b])/,
                                           '[[c]]' => qr/(?^msx:[c])/,
                                           '[[d]]' => qr/(?^msx:[d])/,
                  ...
                  'rules' => {
                               'G0' => [
                                         ...
                                         {
                                           'description' => 'Internal lexical start rule for <[Lex-50]>',
                                           'lhs' => '[:start_lex]',
                                           'rhs' => [
                                                      '[Lex-50]'
                                                    ]
                                         ...
                                         {
                                           'description' => 'Internal lexical start rule for <[Lex-51]>',
                                           'lhs' => '[:start_lex]',
                                           'rhs' => [
                                                      '[Lex-51]'
                                                    ]
                                         ...
                                         {
                                           'description' => 'Internal lexical start rule for <[Lex-52]>',
                                           'lhs' => '[:start_lex]',
                                           'rhs' => [
                                                      '[Lex-52]'
                                                    ]
                                         ...
                                         {
                                           'description' => 'Internal lexical start rule for <[Lex-53]>',
                                           'lhs' => '[:start_lex]',
                                           'rhs' => [
                                                      '[Lex-53]'
                                                    ]
                                         ...
                                         {
                                           'description' => 'Internal rule for single-quoted string \'ranking\'',
                                           'lhs' => '[Lex-38]',
                                           'mask' => [
                                                       1,
                                                       1,
                  ...
                  'symbols' => {
                                 'G0' => {
                                           ...
                                           '[Lex-38]' => {
                                                           'description' => 'Internal lexical symbol for "\'ranking\'"',
                                                           'display_form' => '\'ranking\'',
                                                           'dsl_form' => '\'ranking\''
                                                         },
                                           '[Lex-39]' => {
                                                           'description' => 'Internal lexical symbol for "\'=>\'"',
