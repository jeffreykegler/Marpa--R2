...
$hashed_metag = {
                  ...
                  'rules' => {
                               'G1' => [
                                         ...
                                         {
                                           'action' => '[start,length,values]',
                                           'bless' => 'event_activation_specification',
                                           'description' => 'Empty rule for <event activation specification>',
                                           'lhs' => 'event activation specification',
                                           'name' => 'event activation specification',
                                           'rhs' => []
                                         },
                                         {
                                           'action' => '[start,length,values]',
                                         ...
                                         },
                                         {
                                           ...
                                           'rhs' => [
                                                      ...
                                                      '[Lex-65]',
                                                      'event name',
                                                      'event activation specification'
                                                    ]
                                         },
                                         {
                                           'action' => '[start,length,values]',
