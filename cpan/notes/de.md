...
To generate an event named `wsdiscard`, when a <ws> token is discarded,
...
I add the initialization ability, because I expect applications will often
...
at runtime.
The main expected use of this is to turn on discard events
