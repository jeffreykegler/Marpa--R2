...
sub my_parser {
    ...
    my $recce = Marpa::R2::Scanless::R->new( { grammar => $grammar, trace_terminals => 2, trace_earley_sets => 1 } );
    ...
    say $recce->thick_g1_recce->show_earley_sets(0, -1);
