...
Diagnostics behaviors are a subset of the application behaviors,
and are those that diagnostic or testing code may reasonably
...
A longer discussion of application and diagnostic behaviors
is in the Libmarpa API document.
...
When the thin method corresponding to a Libmarpa method
...
on objects
whose the base grammar is the failure
grammar.
