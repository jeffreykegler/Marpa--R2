...
The definition of ancestry-recoverable failure
to make it analogous to the
Libmarpa API's "ancestry-recoverable failure".
...
environment
than Libmarpa's own.
Calls to these methods are diagnostics behaviors.
