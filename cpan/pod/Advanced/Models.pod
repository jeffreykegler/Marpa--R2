...
the recognizer|Marpa::R2::NAIF::Recognizer> on the assumption
...
as described for
the L<recognizer's C<read> method|Marpa::R2::NAIF::Recognizer/"read()">.
...
calls to
its L<C<read>|Marpa::R2::NAIF::Recognizer/"read()">
