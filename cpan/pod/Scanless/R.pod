...
a discussion in terms of ranges is easier to follow
when fencepost issues are important.
...
C<read()> will read to the end of string,
...
The C<resume()> method will use the physical input stream specified
