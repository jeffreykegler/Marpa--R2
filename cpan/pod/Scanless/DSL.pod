...
It will always possible to disambiguate a SLIF DSL,
...
is LATM.  The default value is 0,
which indicates that a token is not LATM.
...
For historical reasons, LATM lexemes
are also called "forgiving" -- in the original implementation, an
