...
L<C<actions>|Marpa::R2::Scanless::G/"actions">
or 
...
In this document phase and subphase names are capitalized.
for clarity.
...
a call of the L<C<new()>|"new()"> method.
It ends when
...
The logic which ranks parse trees is executed.
