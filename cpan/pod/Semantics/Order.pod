...
but it does not necessarily do do.
...
different rule alternatives,
but the two rule alternatives have the same numeric rank,
...
for RHS alternatives|Marpa::R2::Scanless::R/"null-ranking">
