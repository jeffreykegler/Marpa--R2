...
in other words, am ambiguity is not reported if it is downhill
and does not have a higher altitude.
(Because of cycles,
a downhill glade can have a higher altitude.)
...
The two downglades will differ in length.
...
while other find them distracting,
and segregating them here serves the needs of both.
