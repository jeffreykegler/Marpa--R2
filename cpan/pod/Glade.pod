...
or 'C<phosphorus>',
depending on whether rule 1 or rule 2 is used.
The choice, at glade 2, between rules 1 and 2,
is a symch.
(Hesperus is Venus's traditional name as an evening star,
and Phosphorus and Lucifer are its traditional names as a morning star.)
...
following it up using the accessor methods in this document.
