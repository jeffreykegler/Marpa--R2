...
This is appropriate in most cases, because exhaustion-loving
usually means that exhaustion should occur only at the
end of input string.
But, see below on
...
Exhaustion-sensitivity is not necessarily the best way, or even
a good way,
