...
location.
The reading methods for external scanning
will never go on to read more input at
a later location,
which makes parse exhaustion inside them
unproblematic.
