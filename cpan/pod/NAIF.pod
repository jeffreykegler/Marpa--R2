...
Grammars are
L<C<Marpa::R2::Grammar>|Marpa::R2::NAIF::Grammar> objects.
The reading of input and the evaluation of the parse
according to the semantics is performed by
L<C<Marpa::R2::Recognizer>|Marpa::R2::NAIF::Recognizer> objects.
...
They are created
with the
L<Marpa::R2::Grammar::new|Marpa::R2::NAIF::Grammar/"Constructor">
constructor.
The arguments to
L<Marpa::R2::Grammar::new|Marpa::R2::NAIF::Grammar/"Constructor">
are references to
...
C<Marpa::R2::NAIF::Recognizer::new> creates a new recognizer.
...
The C<Marpa::R2::NAIF::Recognizer::read> method takes two arguments,
...
The C<Marpa::R2::NAIF::Recognizer::value> method returns
a reference to the parse result's value,
if there was a parse result.
If there was no parse result,
C<Marpa::R2::NAIF::Recognizer::value>
returns
C<undef>.

=head2 Resolving the semantics

The first thing C<Marpa::R2::NAIF::Recognizer::value> needs to do is
...
the C<Marpa::R2::NAIF::Recognizer::value> method iterates through the parse results.
For each call,
it returns a reference to the parse result.
At the end of the iteration, after
all parse results have been returned,
C<Marpa::R2::NAIF::Recognizer::value> returns C<undef>.
If there were no parse results,
C<Marpa::R2::NAIF::Recognizer::value> returns C<undef> the first
...
see the
L<Marpa::R2::NAIF::Grammar> document.
For full details on Marpa's recognizer objects and their methods,
see the
L<Marpa::R2::NAIF::Recognizer> document.
...
L<Marpa::R2::NAIF::Semantics> document.
Techniques for tracing and for debugging your Marpa grammars
are described in the
L<Marpa::R2::NAIF::Tracing> document and the
L<Marpa::R2::NAIF::Progress> document.
