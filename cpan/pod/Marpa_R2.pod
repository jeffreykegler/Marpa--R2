...
This is a finished script, so it's not used much,
and in real life you'd might change it.
But here it's kept because it makes for a good template for
a first DSL.
We'll talk about this more when we discuess
