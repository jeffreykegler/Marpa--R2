...
in practical, Marpa will parse it in linear time.
...
Later we will see lexcial rules, which will use
...
It says that Marpa should interpret this rule is lexical and
