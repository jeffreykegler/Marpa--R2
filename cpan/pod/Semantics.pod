...
during the
L<Parse Series Setup Subphase|Marpa::R2::Semantics::Phases/"Parse Series Setup Subphase">.
The Parse Series Setup Subphase occurs during
the first call to a recognizer's L<C<value()>|Marpa::R2::Scanless::R/"value()">
method of the parse series.
More details about
Parse Series Setup Subphase
can be found in
