...
it is called at
L<Node Evaluation Time|Marpa::R2::NAIF::Semantics::Phases/"Tree Traversal Phase">.
...
L<the grammar's C<rule()> method|Marpa::R2::NAIF::Grammar/"rule()">.
...
in the recognizer's
L<C<value>|Marpa::R2::NAIF::Recognizer/"value()"> method.
