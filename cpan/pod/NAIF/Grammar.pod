...
document|Marpa::R2::NAIF::NAIF::Semantics/"Sequence Rule Nodes">.
...
C<Marpa::R2::NAIF::Grammar::new>
returns a new Marpa grammar object or throws an exception.
The arguments to
C<Marpa::R2::NAIF::Grammar::new> are
...
callbacks and
use of L<the progress method|Marpa::R2::NAIF/Progress/progress()>.
...
Details are in
L<the document on semantics|Marpa::R2::NAIF::Semantics>.
...
see L<the document on parse order|Marpa::R2::NAIF::Semantics::Order>.
