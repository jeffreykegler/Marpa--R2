...
on tracing
problems|Marpa::R2::NAIF::Tracing> before
reading this document.

=head1 Introduction to Earley parsing

To read the
L<C<show_progress>|Marpa::R2::NAIF::Recognizer/"show_progress">
...
at the output from
L<C<trace_terminals>|Marpa::R2::NAIF::Recognizer/trace_terminals>.
