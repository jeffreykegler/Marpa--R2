...
the value of the C<bless_package> named argument.
...
If a bless value other than C<::undef> is specified,
C<bless_package> must also be specified,
otherwise a fatal error resuls.
