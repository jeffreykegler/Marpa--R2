...
The format of
Scanless source files is based
on L<the format of
BNF source files|Marpa::R2::BNF>,
...
Single quoted strings can contain any character except
a single quote and vertical whitespace.

Single quotes does not have "escaped" characters.
...
When tracing and debugging parses and grammar,
