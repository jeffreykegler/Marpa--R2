...
=head1 This release is ALPHA and EXPERIMENTAL

This release is alpha and experimental.
At this point features may change incompatibly.
Users who see stability should, for the time being,
prefer L<Marpa::XS>.

Its intended audience is those who want to get a head
start with Marpa::R2 and Libmarpa.
This release does pass an extensive test suite.
...
so they are allowed to default to an arbitrary value.
