...
=head1 This release is beta

This release is beta.
Those who prefer a more stable release should look
at L<Marpa::XS>.
Note that Libmarpa (the C library at the core of Marpa)
and Marpa::R2::Thin (a "thin" interface to Libmarpa)
have their own, separate, release statuses.
which are as stated in their own documentation.
As of this writing, Libmarpa and Marpa::R2::Thin
are alpha.
