...
upper layers for Marpa, or for those who want
to eliminate the overhead of an upper layer from
their application and consider the additional
effort to do that worth while.
...
and situation which depart from the general rules.
