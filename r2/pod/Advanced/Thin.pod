...
The following is the general pattern
for the thin Marpa interfaces.
Iinternal class instance methods for Libmarpa's time classes
...
In general patten of Marpa's thin interface,
...
that whose corresponding Marpa thin method follows the
general pattern.
