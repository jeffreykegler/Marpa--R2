...
the first element
of this array is
a string containing one of the step type
names, as defined in the Libmarpa API document,
or a Perl C<undef>.
A return of C<undef> corresponds to the step
type C<MARPA_STEP_INACTIVE>.
...
The second element is the rule_id id, as returned
