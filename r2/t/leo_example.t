...
0: Statement, lhs=[0]
1: Expression, lhs=[1 2 3 4 5]
2: Lvalue, lhs=[6]
3: AssignOp, lhs=[] terminal
4: AddAssignOp, lhs=[] terminal
5: MinusAssignOp, lhs=[] terminal
6: MultiplyAssignOp, lhs=[] terminal
7: Variable, lhs=[] terminal
8: Statement['], lhs=[7]
END_SYMBOLS
