...
$hashed_metag = {
                  ...
                  'g1_rules' => [
                                  ...
                                  {
                                    'action' => '::dwim',
                                    'bless' => 'bless_lexemes_statement',
                                    'lhs' => 'bless lexemes statement',
                                    'mask' => [
                                                1,
                                                1
                                              ],
                  ...
                  'is_lexeme' => {
                                   ...
                                   'bare name' => '::undef',
                                   'boolean' => '::undef',
                                   'bracketed name' => '::undef',
                                   'character class' => '::undef',
                                   'kwc any' => '::undef',
                                   'kwc ws' => '::undef',
                                   'kwc ws plus' => '::undef',
                                   'kwc ws star' => '::undef',
                                   'op declare bnf' => '::undef',
                                   'op declare match' => '::undef',
                                   'op equal priority' => '::undef',
                                   'op loosen' => '::undef',
                                   'reserved action name' => '::undef',
                                   'reserved blessing name' => '::undef',
                                   'single quoted string' => '::undef',
                                   'standard name' => '::undef'
                                 },
                  'lex_rules' => [
                                   {
