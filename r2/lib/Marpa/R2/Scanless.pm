...
$rule_id = $tracer->rule_new( undef, "action_name", "bare\ name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "action_name", "reserved\ action\ name" );
$mask_by_rule_id[$rule_id] = [1];
...
$rule_id =
  $tracer->rule_new( undef, "discard_rule", "kwc\ discard",
    "op\ declare\ match",
    "single_symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id =
  $tracer->rule_new( undef, "empty_rule", "lhs", "op\ declare", "adverb_list" );
$mask_by_rule_id[$rule_id] = [ 1, 1, 1 ];
$rule_id =
  $tracer->rule_new( undef, "group_association", "kw\ assoc", "op\ arrow",
    "kw\ group" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
$rule_id =
  $tracer->rule_new( undef, "left_association", "kw\ assoc", "op\ arrow",
    "kw\ left" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
...
$rule_id = $tracer->rule_new( undef, "parenthesized\ rhs\ primary\ list",
    "op\ lparen", "rhs_primary_list", "op\ rparen" );
$mask_by_rule_id[$rule_id] = [ 0, 1, 0 ];
$rule_id =
  $tracer->sequence_new( undef, "priorities", "alternatives",
    { separator => "op\ tighter", min => 1, proper => 1, } );
$rule_id = $tracer->rule_new( undef, "priority_rule", "lhs", "op\ declare",
    "priorities" );
$mask_by_rule_id[$rule_id] = [ 1, 1, 1 ];
$rule_id =
  $tracer->rule_new( undef, "proper_specification", "kw\ proper", "op\ arrow",
    "boolean" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "quantified_rule", "lhs", "op\ declare",
...
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "single\ quoted\ string" );
$mask_by_rule_id[$rule_id] = [1];
...
$rule_id =
  $tracer->sequence_new( undef, "rhs_primary_list", "rhs_primary",
    { min => 1, } );
$rule_id =
  $tracer->rule_new( undef, "right_association", "kw\ assoc", "op\ arrow",
    "kw\ right" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
...
$rule_id = $tracer->rule_new( undef, "separator_specification", "kw\ separator",
    "op\ arrow", "single_symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "single_symbol", "character\ class" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "single_symbol", "symbol" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "start_rule", "kwc\ start", "op\ declare",
    "symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "symbol", "symbol_name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "symbol_name", "bare\ name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "symbol_name", "bracketed\ name" );
$mask_by_rule_id[$rule_id] = [1];
