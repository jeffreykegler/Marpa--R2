...
$rule_id =
  $tracer->rule_new( undef, "action", "kw_action", "op_arrow", "action_name" );
...
$rule_id =
  $tracer->rule_new( undef, "discard_rule", "kw__discard", "op_declare_match",
    "single_symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id =
...
$rule_id =
  $tracer->rule_new( undef, "group_association", "kw_assoc", "op_arrow",
    "kw_group" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
$rule_id = $tracer->rule_new( undef, "left_association", "kw_assoc", "op_arrow",
    "kw_left" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
...
$mask_by_rule_id[$rule_id] = [ 1, 1, 1 ];
$rule_id =
  $tracer->rule_new( undef, "proper_specification", "kw_proper", "op_arrow",
    "boolean" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
...
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kw__any" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kw__ws" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kw__ws_plus" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kw__ws_star" );
$mask_by_rule_id[$rule_id] = [1];
...
$rule_id =
  $tracer->sequence_new( undef, "rhs_primary_list", "rhs_primary",
    { min => 1, } );
$rule_id =
  $tracer->rule_new( undef, "right_association", "kw_assoc", "op_arrow",
    "kw_right" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
...
$rule_id = $tracer->rule_new( undef, "separator_specification", "kw_separator",
...
$mask_by_rule_id[$rule_id] = [1];
$rule_id =
  $tracer->rule_new( undef, "start_rule", "kw__start", "op_declare", "symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
...
my %actions_by_rhs_symbol = (
    kw__ws_star          => 'do_ws_star',
    kw__ws_plus          => 'do_ws_plus',
    kw__ws               => 'do_ws',
    kw__any              => 'do_any',
