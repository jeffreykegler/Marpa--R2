...
$rule_id =
  $tracer->rule_new( undef, "action", "kw\ action", "op_arrow", "action_name" );
...
$mask_by_rule_id[$rule_id] = [1];
$rule_id =
  $tracer->sequence_new( undef, "adverb_list", "adverb_item", { min => 0, } );
$rule_id = $tracer->rule_new( undef, "alternative", "rhs", "adverb_list" );
$mask_by_rule_id[$rule_id] = [ 1, 1 ];
$rule_id =
  $tracer->sequence_new( undef, "alternatives", "alternative",
    { separator => "op_eq_pri", min => 1, proper => 1, } );
$rule_id =
  $tracer->rule_new( undef, "discard_rule", "kwc\ discard", "op_declare_match",
    "single_symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id =
  $tracer->rule_new( undef, "empty_rule", "lhs", "op_declare", "adverb_list" );
$mask_by_rule_id[$rule_id] = [ 1, 1, 1 ];
$rule_id =
  $tracer->rule_new( undef, "group_association", "kw\ assoc", "op_arrow",
    "kw\ group" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
$rule_id =
  $tracer->rule_new( undef, "left_association", "kw\ assoc", "op_arrow",
    "kw\ left" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
$rule_id = $tracer->rule_new( undef, "lhs", "symbol_name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "op_declare", "op_declare_bnf" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "op_declare", "op_declare_match" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "parenthesized\ rhs\ primary\ list",
    "op_lparen", "rhs_primary_list", "op_rparen" );
$mask_by_rule_id[$rule_id] = [ 0, 1, 0 ];
$rule_id =
  $tracer->sequence_new( undef, "priorities", "alternatives",
    { separator => "op_tighter", min => 1, proper => 1, } );
$rule_id = $tracer->rule_new( undef, "priority_rule", "lhs", "op_declare",
    "priorities" );
$mask_by_rule_id[$rule_id] = [ 1, 1, 1 ];
$rule_id =
  $tracer->rule_new( undef, "proper_specification", "kw\ proper", "op_arrow",
    "boolean" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "quantified_rule", "lhs", "op_declare",
    "single_symbol", "quantifier", "adverb_list" );
$mask_by_rule_id[$rule_id] = [ 1, 1, 1, 1, 1 ];
$rule_id = $tracer->rule_new( undef, "quantifier", "op_plus" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "quantifier", "op_star" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ action" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ assoc" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ group" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ left" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ proper" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ right" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "reserved_word", "kw\ separator" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->sequence_new( undef, "rhs", "rhs_primary", { min => 1, } );
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kwc\ any" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kwc\ ws" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kwc\ ws\ plus" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kwc\ ws\ star" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary",
    "parenthesized\ rhs\ primary\ list" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "single_quoted_string" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "single_symbol" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id =
  $tracer->sequence_new( undef, "rhs_primary_list", "rhs_primary",
    { min => 1, } );
$rule_id =
  $tracer->rule_new( undef, "right_association", "kw\ assoc", "op_arrow",
    "kw\ right" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 0 ];
...
$rule_id = $tracer->rule_new( undef, "separator_specification", "kw\ separator",
    "op_arrow", "single_symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "single_symbol", "character_class" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "single_symbol", "symbol" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "start_rule", "kwc\ start", "op_declare",
    "symbol" );
$mask_by_rule_id[$rule_id] = [ 0, 0, 1 ];
$rule_id = $tracer->rule_new( undef, "symbol", "symbol_name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "symbol_name", "bare_name" );
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "symbol_name", "bracketed_name" );
$mask_by_rule_id[$rule_id] = [1];
...
my %actions_by_rhs_symbol = (
    ...
    'kwc ws'             => 'do_ws',
    'kwc any'            => 'do_any',
    single_quoted_string => 'do_single_quoted_string',
    character_class      => 'do_character_class',
    bracketed_name       => 'do_bracketed_name',
    op_star              => 'do_op_star_quantifier',
    op_plus              => 'do_op_plus_quantifier',
    op_declare_bnf       => 'do_op_declare_bnf',
    op_declare_match     => 'do_op_declare_match',
);
...
my %actions_by_lhs_symbol = (
    ...
    rhs                              => 'do_rhs',
    lhs                              => 'do_lhs',
    rhs_primary_list                 => 'do_rhs_primary_list',
    'parenthesized rhs primary list' => 'do_parenthesized_rhs_primary_list',
    rules                            => 'do_rules',
    start_rule                       => 'do_start_rule',
    priority_rule                    => 'do_priority_rule',
    empty_rule                       => 'do_empty_rule',
    quantified_rule                  => 'do_quantified_rule',
    discard_rule                     => 'do_discard_rule',
    priorities                       => 'do_discard_separators',
    alternatives                     => 'do_discard_separators',
    alternative                      => 'do_alternative',
    adverb_list                      => 'do_adverb_list',
    action                           => 'do_action',
    left_association                 => 'do_left_association',
    right_association                => 'do_right_association',
    group_association                => 'do_group_association',
    separator_specification          => 'do_separator_specification',
    proper_specification             => 'do_proper_specification',
);
