...
sub do_end_of_input {
    Marpa::R2::exception( ':$ not allowed unless grammar is scannerless');
}
...
$mask_by_rule_id[$rule_id] = [1];
$rule_id = $tracer->rule_new( undef, "rhs_primary", "kw__end_of_input" );
$mask_by_rule_id[$rule_id] = [1];
...
my %actions_by_rhs_symbol = (
 ...
 kw__ws => 'do_ws',
 kw__any => 'do_any',
 kw__end_of_input => 'do_end_of_input',
