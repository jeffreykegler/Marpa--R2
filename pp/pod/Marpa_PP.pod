...
L<Marpa::PP> parses any language whose
...
Marpa grammars are L<Marpa::PP::Grammar> objects.
They are created
with the
...
L<Marpa::PP::Parse_Terms> is intended as a quick refresher in
parsing terminology.
...
L<Marpa::PP::Advanced::Algorithm> describes the Marpa algorithm itself.
...
L<another
document|Marpa::PP::Advanced::Algorithm>.
