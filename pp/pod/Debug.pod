...
You can find out the current location using the
L<C<current_earleme> method|Marpa::PP::Recognizer/"current_earleme">.
...
Earleme 3 is the current location and this is no coincidence.
