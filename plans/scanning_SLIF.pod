...
For the parsing theory literature,
...
all lexemes are required to correspond to a span of the input string.
Applications which want to use lexemes which do not have a natural relationship
to a span of the input string must arrange one.
