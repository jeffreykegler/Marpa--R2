...
sub Marpa::XS::Recognizer::old_show_and_node {
    ...
    my $name = Marpa::XS::Recognizer::and_node_tag($recce, $and_node);
...
sub Marpa::XS::Recognizer::old_show_or_node {
	...
	my $or_node_tag = Marpa::XS::Recognizer::or_node_tag($recce, $or_node);
...
sub Marpa::XS::Recognizer::value {
    ...
    TASK: while ( my $task = pop @task_list ) {
        ...
        if ( $task_type == Marpa::XS::Internal::Task::POPULATE_OR_NODE ) {
            ...
            my $work_node_name =
		Marpa::XS::Recognizer::or_node_tag($recce, $work_or_node);
