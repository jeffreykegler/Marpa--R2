...
# A version of the ah2.t test which tries to be exactly the
# same, except that it does NOT use the PP shim,
# but invokes Marpa::XS the way a user might.
# This is to make sure that all will be well outside the
# test environment, as well as in it.
use 5.010;
use strict;
use warnings;
