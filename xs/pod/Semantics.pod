...
=item * A Tree Setup Phase, followed by
...
all the Tree Setup Phases occur
after the Series Setup Phase.
For each parse tree,
the Tree Setup Phase occurs before
...
which follows the Tree Setup Phase.
