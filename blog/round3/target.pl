...
CREATE_STRING: {
    ...
    if (defined $target_position) {
        $s = ('(' x $target_position) . $s_balanced;
        my $remaining_length = $length - length $s;
	die "String of length $length is too small for pos=$target_position"
...
sub do_r2 {
    ...
    say qq{r2: "$value" at $start_of_match-$end_of_match of }, length $s;
    return 0;
...
sub do_thin {
    ...
    say qq{thin: "$value" at $start_of_match-$end_of_match of }, length $s;
    return 0;
...
sub do_thinsl {
    ...
    say qq{thinsl: "$value" at $start_of_match-$end_of_match_earleme of }, length $s;
    return 0;
...
sub do_flm {
    ...
    say qq{flm: "$value" at $start_of_match-$end_of_match of }, length $s;
    return 0;
...
sub do_flmsl {
    ...
    say qq{flmsl: "$value" at $start_of_match-$end_of_match of }, length $s;
    return 0;
